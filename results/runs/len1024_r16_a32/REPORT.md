...
- Best validation loss: **0.3142**
- Wall time: **12.3 minutes**
- Maximum allocated GPU memory: **11.45 GiB**
...
| Metric | Base | Adapter |
|---|---:|---:|
| Greedy exact match | 72.0% | 26.0% |
| Valid three-tag format | 65.0% | 27.0% |
| Reflection present | 91.0% | 28.0% |
| Self-consistency N=10 | 91.0% | 52.0% |

Adapter minus base greedy accuracy:
**-46.0 percentage points**
